    ...
    <div class="bg-white rounded-xl shadow-sm p-8">
        <form method="POST" action="{{ route('client.profile.update') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            required
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 @error('firstname') border-red-500 @enderror"
                        >
                        @error('firstname')
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            required
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 @error('lastname') border-red-500 @enderror"
                        >
                        @error('lastname')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            id="new_password" 
                            name="new_password" 
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 @error('new_password') border-red-500 @enderror"
                            placeholder="••••••••"
                        >
                        @error('new_password')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                <a href="{{ route('client.profile') }}" class="px-6 py-3 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition">
