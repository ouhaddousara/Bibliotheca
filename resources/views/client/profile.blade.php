...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <div class="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white rounded-xl p-8 shadow-lg">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('client.profile.edit') }}" class="bg-white text-emerald-600 px-6 py-3 rounded-lg font-semibold hover:bg-emerald-50 transition flex items-center">
            ...
            <div class="p-6">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-gray-800 font-medium mt-1">{{ $member->email }}</p>
                    </div>
            ...
            <div class="p-6">
                <div class="flex justify-between items-start">
                    ...
                    <span class="text-sm text-gray-500">
                        Adhérent depuis le {{ $member->created_at->format('d/m/Y') }}
                    </span>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <a href="{{ route('client.books.index') }}" class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-emerald-500 hover:shadow-md transition">
        ...
        <a href="{{ route('client.loans.index') }}" class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-indigo-500 hover:shadow-md transition">
            <div class="flex items-center">
