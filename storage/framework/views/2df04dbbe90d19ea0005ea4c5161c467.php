...
<div class="space-y-8">
    ...
    <div class="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white rounded-xl p-8 shadow-lg">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
                <h1 class="text-3xl font-bold mb-2">👋 Bonjour, <?php echo e(auth('client')->user()->firstname); ?> !</h1>
                <p class="text-emerald-100 text-lg">Bienvenue dans votre espace personnel de la bibliothèque</p>
            </div>
            <div class="mt-4 md:mt-0 flex items-center space-x-4">
                <div class="text-center">
                    <div class="text-4xl font-bold"><?php echo e($stats['active_loans']); ?></div>
                    <div class="text-emerald-100 text-sm">Emprunts en cours</div>
                </div>
                <div class="w-px h-12 bg-emerald-400"></div>
                <div class="text-center">
                    <div class="text-4xl font-bold text-red-200"><?php echo e($stats['overdue_loans']); ?></div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-emerald-500 hover:shadow-md transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800"><?php echo e($stats['active_loans']); ?></p>
                    <p class="text-emerald-600 text-sm mt-1 flex items-center">
                        <i class="fas fa-book-reader mr-1 text-xs"></i>
                        <?php echo e($stats['available_books']); ?> livres disponibles
                    </p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-green-500 hover:shadow-md transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800"><?php echo e($stats['returned_loans']); ?></p>
        ...
        <!-- Emprunts en retard -->
        <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 <?php echo e($stats['overdue_loans'] > 0 ? 'border-red-500' : 'border-gray-300'); ?> hover:shadow-md transition">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-500 text-sm font-medium mb-1">Emprunts en retard</p>
                    <p class="text-3xl font-bold <?php echo e($stats['overdue_loans'] > 0 ? 'text-red-600' : 'text-gray-800'); ?>"><?php echo e($stats['overdue_loans']); ?></p>
            ...
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="font-bold text-xl text-gray-800 flex items-center">
                        ...
                        Vous avez <?php echo e($overdueLoans->count()); ?> emprunt(s) en retard !
                    </h3>
                    <p class="mt-2 text-gray-700">
                        Merci de rapporter ces livres dès que possible pour éviter des frais de retard.
                    </p>
                    <div class="mt-4">
                        <a href="<?php echo e(route('client.loans.index')); ?>" class="inline-flex items-center px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition">
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <div class="p-6 border-b border-gray-200 bg-emerald-50">
            <h2 class="text-xl font-bold text-gray-800 flex items-center">
                ...
                Livres disponibles (<?php echo e($stats['available_books']); ?>)
            </h2>
        ...
        <div class="p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <?php $__currentLoopData = $availableBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-gray-50 rounded-xl p-4 hover:bg-gray-100 transition cursor-pointer" 
                     onclick="window.location.href='<?php echo e(route('client.books.index')); ?>'">
                    <div class="bg-white rounded-lg p-4 shadow-sm">
                        <div class="text-4xl mb-3 text-emerald-600 text-center">
                            <i class="fas fa-book"></i>
                        </div>
                        <h3 class="font-bold text-gray-800 mb-1 line-clamp-2"><?php echo e(Str::limit($book->title, 30)); ?></h3>
                        <p class="text-sm text-gray-600 mb-2"><?php echo e($book->author); ?></p>
        ...
        <div class="p-6 border-t border-gray-200">
            <div class="mt-4 text-center">
                <a href="<?php echo e(route('client.books.index')); ?>" class="inline-flex items-center justify-center text-emerald-600 hover:text-emerald-800 font-medium text-lg">
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <div class="p-6 border-b border-gray-200 bg-indigo-50">
            <h2 class="text-xl font-bold text-gray-800 flex items-center">
                ...
                Mes emprunts récents (<?php echo e($recentLoans->count()); ?>)
            </h2>
        ...
        <div class="p-6 border-t border-gray-200">
            <div class="mt-4 text-center">
                <a href="<?php echo e(route('client.loans.index')); ?>" class="inline-flex items-center justify-center text-emerald-600 hover:text-emerald-800 font-medium text-lg">
...
<?php echo $__env->make('client.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\GestionBiblio\resources\views/client/dashboard.blade.php ENDPATH**/ ?>