...
<body class="bg-gray-100">
    ...
    <div id="sidebar" class="bg-emerald-800 text-white h-screen fixed left-0 top-0 w-64 flex flex-col">
        ...
        <nav class="mt-6 px-4 flex-1 overflow-y-auto">
            <a href="<?php echo e(route('client.dashboard')); ?>" class="sidebar-item flex items-center space-x-3 py-3 px-4 rounded-lg <?php echo e(request()->routeIs('client.dashboard') ? 'active' : ''); ?>">
                <i class="fas fa-home text-lg"></i>
                <span>Accueil</span>
            </a>
            <a href="<?php echo e(route('client.books.index')); ?>" class="sidebar-item flex items-center space-x-3 py-3 px-4 rounded-lg <?php echo e(request()->routeIs('client.books.*') ? 'active' : ''); ?>">
                <i class="fas fa-book text-lg"></i>
                <span>Livres disponibles</span>
            </a>
            <a href="<?php echo e(route('client.loans.index')); ?>" class="sidebar-item flex items-center space-x-3 py-3 px-4 rounded-lg <?php echo e(request()->routeIs('client.loans.*') ? 'active' : ''); ?>">
                <i class="fas fa-list text-lg"></i>
                <span>Mes emprunts</span>
            </a>
            <a href="<?php echo e(route('client.profile')); ?>" class="sidebar-item flex items-center space-x-3 py-3 px-4 rounded-lg <?php echo e(request()->routeIs('client.profile') ? 'active' : ''); ?>">
        ...
        <div class="px-4 py-4 border-t border-emerald-700">
            <form method="POST" action="<?php echo e(route('client.logout')); ?>" class="w-full">
                <?php echo csrf_field(); ?>
    ...
    <!-- Main Content -->
    <div class="main-content min-h-screen <?php echo e(auth('client')->check() ? 'ml-64' : 'ml-0'); ?>">
            ...
            <div class="flex items-center justify-between px-6 py-4">
                ...
                <div class="flex-1">
                    <h1 class="text-2xl font-bold text-gray-800">
                        👋 Bonjour, <?php echo e(auth('client')->user()->firstname); ?> !
                    </h1>
                ...
                <div class="flex items-center space-x-3">
                    <div class="text-right">
                        <p class="text-sm font-semibold text-gray-800"><?php echo e(auth('client')->user()->firstname); ?> <?php echo e(auth('client')->user()->lastname); ?></p>
                        <p class="text-xs text-gray-500"><?php echo e(auth('client')->user()->email); ?></p>
                    </div>
                    <div class="w-10 h-10 bg-emerald-600 rounded-full flex items-center justify-center text-white font-bold">
                        <?php echo e(strtoupper(substr(auth('client')->user()->firstname, 0, 1))); ?>
        ...
        <footer class="bg-white border-t border-gray-200 mt-auto">
            <div class="px-6 py-8 max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <ul class="space-y-2">
                                <li><a href="<?php echo e(route('client.books.index')); ?>" class="text-gray-600 hover:text-emerald-600 text-sm transition">Livres disponibles</a></li>
                                <li><a href="<?php echo e(route('client.loans.index')); ?>" class="text-gray-600 hover:text-emerald-600 text-sm transition">Mes emprunts</a></li>
                                <li><a href="<?php echo e(route('client.profile')); ?>" class="text-gray-600 hover:text-emerald-600 text-sm transition">Mon profil</a></li>
                                <li><a href="<?php echo e(route('client.dashboard')); ?>" class="text-gray-600 hover:text-emerald-600 text-sm transition">Tableau de bord</a></li>
                            </ul>
                        </div>
                ...
                <div class="border-t border-gray-200 mt-8 pt-6 text-center text-gray-500 text-sm">
                    <p>© <?php echo e(date('Y')); ?> Bibliothèque - Tous droits réservés</p>
...
</html><?php /**PATH C:\Users\HP\GestionBiblio\resources\views/client/layouts/app.blade.php ENDPATH**/ ?>